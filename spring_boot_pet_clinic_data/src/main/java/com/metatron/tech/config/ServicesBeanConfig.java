...
public class ServicesBeanConfig {
    ...
    * file for the bean not found exception*/
    ...
    @Bean
    ServiceBeanFactory getServiceBeanFactory(VetService vetService, OwnerService ownerService, PetService petService, PetTypeService petTypeService, SpecialtyService specialtyService, VisitService visitService, RoleService roleService, UsersService usersService, PrivilegeService privilegeService){
        return new ServiceBeanFactory(vetService,ownerService, petService, petTypeService, specialtyService, visitService,roleService, usersService, privilegeService);
    }
